...
namespace myslam {
    Viewer::Viewer() {
        viewer_thread_ = std::thread(std::bind(&myslam::Viewer::ThreadLoop, this));
    }
    ...
    void Viewer::DrawMapPoints() {
        ...
        glPointSize(2);
        glBegin(GL_POINTS);
        for (auto &landmark : activate_landmarkes_) {
    ...
    void Viewer::DrawFrame(myslam::Frame::Ptr frame, const float *color) {
